  ...
  return (
    <section id="lifecycle" className="scroll-mt-24 py-20 md:py-28">
      <Container>
        ...
        <Reveal delay={140}>
          <p className="mt-5 max-w-2xl text-lg text-muted-ink">{lifecycle.intro}</p>
        </Reveal>
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {lifecycle.phases.map((phase, i) => (
            ...
            >
              ...
              <p className="mt-3 text-xs font-semibold uppercase tracking-[0.12em] text-accent">Who I work with</p>
              <p className="mt-1.5 text-sm leading-snug text-muted-ink">{phase.collab}</p>

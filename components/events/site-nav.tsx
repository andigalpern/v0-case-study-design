      ...
      <nav className={cn(containerClass, "flex h-16 items-center justify-between gap-4")}>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <a
            ...
            className="hidden items-center gap-1.5 rounded-full bg-accent-gradient text-white shadow-accent px-4 py-2 text-sm font-semibold transition-transform duration-200 hover:-translate-y-0.5 sm:inline-flex"
          >
            Let&apos;s talk

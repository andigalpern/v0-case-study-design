...
export default function AnnaRodriguezProfile() {
      ...
      <main className="px-6 py-8 space-y-6 animate-fade-in-up max-w-4xl mx-auto">
        ...
        <section className="bg-white rounded-3xl p-8 shadow-lg">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Anna Rodriguez</h1>
              <p className="text-xl text-gray-600">@annarodriguez</p>
              <p className="text-gray-500 mt-1">Fort Lauderdale, FL</p>
            </div>
          ...
          <div className="mt-8 space-y-4">
            ...
            <p className="text-gray-700">Advanced Open Water • 42 dives</p>
          ...
          <div className="mt-8 space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              Marine biologist and passionate diver. Love exploring coral reefs and documenting sea life. Always looking for new dive buddies!
            </p>
          </div>
          ...
          <div className="mt-8 space-y-3">
            ...
            <div className="space-y-2 text-gray-700">
              <div>
                <p className="font-medium">Key Largo, FL</p>
                <p className="text-sm text-gray-500">Today</p>
              </div>
              <div>
                <p className="font-medium">Biscayne Bay, FL</p>
        ...
        <section className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-lg animate-fade-in-up" style={{animationDelay: '0.1s'}}>
          ...
          <p className="text-gray-800 leading-relaxed mb-4">
            Anna is an amazing dive buddy! Her knowledge of marine life made our dive so much more educational and fun. She's patient, safety-conscious, and great at spotting wildlife.
          </p>
          <div className="flex items-center gap-3 text-gray-600">
            <MessageSquare className="w-5 h-5" />
            <div>
              <p className="font-semibold text-gray-900">Leilani Chen</p>
              <p className="text-sm">Nov. 10, 2025</p>
            </div>
          </div>
        </section>

...
export default function AlexHaydesProfile() {
      ...
      <main className="px-6 py-8 space-y-6 animate-fade-in-up max-w-4xl mx-auto">
        ...
        <section className="bg-white rounded-3xl p-8 shadow-lg">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Alex Haydes</h1>
              <p className="text-xl text-gray-600">@alexhaydes</p>
              <p className="text-gray-500 mt-1">Key Biscayne, FL</p>
            </div>
          ...
          <div className="mt-8 space-y-4">
            ...
            <p className="text-gray-700">Open Water Diver • 68 dives</p>
          ...
          <div className="mt-8 space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              Weekend warrior diver and underwater videographer. Love capturing the beauty of coral reefs and marine ecosystems. Based in Key Biscayne, always down for a morning dive!
            </p>
          </div>
        ...
        <section className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-lg animate-fade-in-up" style={{animationDelay: '0.1s'}}>
          ...
          <p className="text-gray-800 leading-relaxed mb-4">
            Great dive buddy! Alex knows all the best spots around Key Biscayne and his underwater videos are stunning. Really professional and fun to dive with.
          </p>
          <div className="flex items-center gap-3 text-gray-600">
            <MessageSquare className="w-5 h-5" />
            <div>
              <p className="font-semibold text-gray-900">Marcus Johnson</p>
              <p className="text-sm">Nov. 14, 2025</p>
            </div>
          </div>
        </section>

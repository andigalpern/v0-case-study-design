        ...
        <section className="container mx-auto px-6 py-20 md:py-32">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-xl leading-relaxed text-brand-gray-dark">
              <p>
                I'm a Product & Content Designer who lives at the intersection of Growth, AI, and human-centered design. For more than 14 years, I've helped companies of every size—from global teams at Adobe and Informatica to scrappy, fast-moving startups—turn complex problems into clear, effective digital experiences and compelling product narratives that drive user acquisition and revenue growth.
              </p>
              
              <p>
                My work blends product design, content strategy, growth tactics, and marketing to increase leads, boost conversions, and build experiences people genuinely want to use. I craft not just beautiful interfaces, but the messaging and content that makes products instantly understandable and irresistible.
              </p>
              ...
              {[
                {
                  ...
                  description: "I don't guess—I validate. Every design and content decision is backed by user research, analytics, or A/B test results. I speak the language of metrics because growth requires measurement."
                },
                {
                  title: "AI Product & Content Fluency",
                  description: "Deep experience designing conversational interfaces, recommendation systems, and ML-powered features. I understand how to make AI feel natural through thoughtful content design that builds trust in intelligent systems."
                },
                {
                  title: "Full-Funnel Content & Design Thinking",
                  description: "From awareness to advocacy, I design the complete journey with cohesive content strategy. Landing pages, onboarding flows, email campaigns, in-product messaging, and growth loops—all orchestrated with compelling narratives for sustainable growth."
                },
                {
                  title: "Cross-Functional Leadership",
                  description: "I've led initiatives spanning design, content, engineering, marketing, and sales. I translate between stakeholders, align teams around shared goals, and maintain quality in both visual design and editorial voice while moving fast."
                }
              ].map((skill, index) => (
